...
unsigned char code ucSeqPick[7][10][5] =  {{{0x66,0x40,0x01,0x5B,0x01}, 
                                            ...
                                            {0x6B,0x74,0x29,0x87,0x83},  // 6 Saisie Pile 9V
                                            {0x6B,0x74,0x29,0x87,0x93},  // 7 Saisie Pile AA
                                            {0x6B,0x62,0x2A,0x95,0x93},  // 8 Monte
                                            {0x69,0x6D,0x3B,0x95,0x93}}, // 9 Tourne vers Balance Fin Seq 0
                      // Seq 1   (case B5)
                                           {{0x66,0x40,0x01,0x5B,0x01},  // Pos 0 seq 1 Case C3
                                            {0x6A,0x52,0x1B,0x61,0x01},
                                            {0x72,0x68,0x1E,0x4D,0x01},  // 2 Au dessus C3
                                            {0x72,0x67,0x1E,0x8A,0x01},  // 3 Pince vers Bas
                                            {0x72,0x6C,0x1D,0x84,0x01},  // 4 Autour Pile
                                            {0x72,0x6C,0x1D,0x84,0x57},  // 5 Saisie Pile C
                                            {0x72,0x6C,0x1D,0x84,0x83},  // 6 Saisie Pile 9V
                                            {0x72,0x6C,0x1D,0x84,0x93},  // 7 Saisie Pile AA
                                            {0x72,0x62,0x2A,0x95,0x93},                               
                                            {0x69,0x6D,0x3B,0x95,0x93}}, // Fin seq 1
                      // Seq 2  (case C4)      
                                           {{0x66,0x40,0x01,0x5B,0x01},  // Pos 0 seq 2 Case
                                            ...
                                            {0x68,0x66,0x01,0x38,0x01},
                                            {0x68,0x66,0x01,0x38,0x01}}, // Fin seq 2
                      // Seq 3  (Balance)     
                                           {{0x65,0x69,0x30,0x95,0x93},  // 0 Pos 0 seq 3  Vers Balance
                                            {0x65,0x72,0x3B,0x95,0x93},  // 1 On descent.
                                            {0x65,0x79,0x49,0x9B,0x93},  // 2  
                                            {0x65,0x80,0x58,0xA0,0x93},  // 3
                                            {0x65,0x8C,0x5D,0x9C,0x93},  // 4 Sur la balance
                                            {0x65,0x8C,0x5D,0x9C,0x01},  // 5 Lache la pile
                                            {0x65,0x8C,0x5D,0x9C,0x01},  // 6
                                            {0x65,0x8C,0x5D,0x9C,0x93},  // 7 Reprend la pile.
                                            {0x65,0x83,0x5A,0x9C,0x93},  // 8 Monte                      
                                            {0x6A,0x83,0x5A,0x9C,0x93}}, // 9 Tourne devant Fin Seq 3                                                        
                      // Seq 4  (20g)
                                           {{0x6A,0x78,0x4E,0x9C,0x93}, // 0 Monte Pos 0 seq 5 Bal-> 9V
                                            {0x6A,0x78,0x4E,0x9C,0x93}, // 1 Monte 
                                            {0x73,0x78,0x4E,0x9C,0x93}, // 2 Tourne
                                            {0x73,0x7E,0x53,0x9C,0x93}, // 3 Baisse
                                            {0x73,0x81,0x55,0x9C,0x93}, // 4 Baisse
                                            {0x73,0x83,0x45,0x8F,0x93}, // 6 Sur Depot
                                            {0x73,0x83,0x45,0x8F,0x01}, // 7 Lache
                                            {0x73,0x7A,0x47,0x8F,0x01}, // 8 Monte  
                                            {0x73,0x65,0x47,0x8F,0x01},
                                            {0x66,0x40,0x01,0x5B,0x01}},// 9 Fin seq 5  Repos
                      // Seq 5  (50g)
                                           {{0x6A,0x78,0x4E,0x9C,0x93}, // 0 Monte Pos 0 seq 5 Bal-> C
                                            {0x6A,0x78,0x4E,0x9C,0x93}, // 1 Monte 
                                            {0x78,0x78,0x4E,0x9C,0x93}, // 2 Tourne
                                            {0x78,0x7E,0x53,0x9C,0x93}, // 3 Baisse
                                            {0x78,0x82,0x54,0x9A,0x93}, // 5 Baisse
                                            {0x78,0x84,0x48,0x8F,0x93}, // 6 Sur Depot
                                            {0x78,0x84,0x48,0x8F,0x01}, // 7 Lache
                                            {0x78,0x7A,0x48,0x8F,0x01}, // 8 Monte   
                                            {0x78,0x65,0x48,0x8F,0x01},
                                            {0x66,0x40,0x01,0x5B,0x01}},// 9 Fin seq 5  Repos
                      // Seq 6  (80g)
                                           {{0x6A,0x78,0x4E,0x9C,0x93}, // 0 Monte Pos 0 seq 5 Bal-> C
                                            {0x6A,0x78,0x4E,0x9C,0x93}, // 1 Monte 
                                            {0x7C,0x78,0x4E,0x9C,0x93}, // 2 Tourne
                                            {0x7C,0x7E,0x53,0x9C,0x93}, // 3 Baisse
                                            {0x7C,0x83,0x52,0x9A,0x93}, // 5 Baisse
                                            {0x7C,0x88,0x50,0x91,0x93}, // 6 Sur Depot
                                            {0x7C,0x88,0x50,0x91,0x01}, // 7 Lache
                                            {0x7C,0x7A,0x50,0x91,0x01}, // 8 Monte 
